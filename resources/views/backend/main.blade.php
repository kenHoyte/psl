            ...
            <div class="main-icon-menu slimscroll-menu" style="background-color:rgb(0, 146, 114)">
                ...
                <nav class="nav">
                    ...
                    <a href="#MetricaPages" class="nav-link" data-toggle="tooltip-custom" data-placement="right"  data-trigger="hover" title="" data-original-title="Pages">
                        ...
                        <i data-feather="lock" class="align-self-center menu-icon icon-dual">
                ...
                <div class="menu-body slimscroll">                    
                    ...
                    <div id="MetricaApps" class="main-icon-menu-pane">
                        ...
                        <ul class="nav metismenu">
                            <li class="nav-item">
                                <a class="nav-link" href="javascript: void(0);"><span class="w-100">Treasury Bill</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="analytics-customers.html">Sign-ons</a></li>
                                    <li><a href="analytics-customers.html">Customers</a></li>
                                    <li><a href="analytics-reports.html">Reports</a></li>            
                                </ul>            
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="javascript: void(0);"><span class="w-100">Fixed Deposit</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
